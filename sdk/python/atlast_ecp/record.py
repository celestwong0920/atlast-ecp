...
def create_record(
    ...
    partial = {
        ...
        "step": {
            ...
            **({"cost_usd": step.cost_usd} if step.cost_usd is not None else {}),
            **({"parent_agent": step.parent_agent} if step.parent_agent else {}),
            **({"session_id": step.session_id} if step.session_id else {}),
            **({"delegation_id": step.delegation_id} if step.delegation_id else {}),
            **({"delegation_depth": step.delegation_depth} if step.delegation_depth is not None else {}),
        },
